...
# Build model
model = M.unet_detail(input_size = (288,384,3))
#model.load_weights('weight_isic181')
model.summary()
...
mcp_save = ModelCheckpoint('weight_isic18', save_best_only=True, monitor='val_acc', mode='max')
